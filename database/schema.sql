-- =============================================================================
-- NOURLA BOUTIQUE HOTEL - DATABASE SCHEMA SQL
-- ElektraWeb PMS + Ziraat Sanal POS / Mock Payment Integration
...
-- -----------------------------------------------------------------------------
-- 6. RESERVATIONS (With Immutable Snapshot)
-- -----------------------------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS PAYMENT_TRANSACTIONS (
  ...
  reservation_id INTEGER NOT NULL,
  transaction_type VARCHAR(50) NOT NULL, -- SALE, 3D_SECURE, REFUND, CANCEL
  amount DECIMAL(10, 2) NOT NULL,
  currency VARCHAR(10) DEFAULT 'TRY',
...
-- =============================================================================
-- INDEXES FOR HIGH PERFORMANCE AND SECURITY
-- =============================================================================
