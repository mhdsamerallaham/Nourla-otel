...
SELECT h.id, 3219, 'STD', 'Standart Oda', '38 m²', 2, 320.00 FROM hotels h WHERE h.pms_hotel_id = '37555'
ON CONFLICT (pms_room_type_id) DO NOTHING;

INSERT INTO rooms (hotel_id, pms_room_type_id, code, name_tr, size_m2, max_adults, base_price)
SELECT h.id, 3220, 'TSR', 'Tasarım Oda', '44 m²', 2, 380.00 FROM hotels h WHERE h.pms_hotel_id = '37555'
ON CONFLICT (pms_room_type_id) DO NOTHING;

INSERT INTO rooms (hotel_id, pms_room_type_id, code, name_tr, size_m2, max_adults, base_price)
SELECT h.id, 3221, 'STSR', 'Superior Tasarım Oda', '52 m²', 2, 450.00 FROM hotels h WHERE h.pms_hotel_id = '37555'
ON CONFLICT (pms_room_type_id) DO NOTHING;

INSERT INTO rooms (hotel_id, pms_room_type_id, code, name_tr, size_m2, max_adults, base_price)
SELECT h.id, 3222, 'SUIT', 'Süit Oda', '60 m²', 3, 550.00 FROM hotels h WHERE h.pms_hotel_id = '37555'
ON CONFLICT (pms_room_type_id) DO NOTHING;

INSERT INTO rooms (hotel_id, pms_room_type_id, code, name_tr, size_m2, max_adults, base_price)
SELECT h.id, 3223, 'LOFT', 'Loft Villa', '85 m²', 3, 750.00 FROM hotels h WHERE h.pms_hotel_id = '37555'
ON CONFLICT (pms_room_type_id) DO NOTHING;
