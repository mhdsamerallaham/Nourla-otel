...
import { ArrowRight, Wine, UtensilsCrossed, Sparkles, Calendar, Zap } from 'lucide-react';
...
export default function TestScrollVideo() {
  ...
  return (
    <div className="min-h-screen">
      {/* Test Banner Notice */}
      <div className="bg-[#4F523A] text-[#E7E1D3] py-2 px-4 text-center text-xs font-mono tracking-wide z-50 relative border-b border-[#E7E1D3]/20 flex items-center justify-center gap-2">
        <Zap className="w-3.5 h-3.5 text-amber-300 animate-pulse" />
        <span>REFACTORED ENGINE: 150 WebP Frames (Desktop 1280px / Mobile 720px) • 60 FPS LERP</span>
      </div>

      {/* 1. ULTRA-SMOOTH REFACTORED SCROLL ANIMATION */}
      <ScrollAnimation
        totalFrames={300}
        scrollMultiplier={5}
        debugMode={true}
